...
SECRET_KEY = 'django-insecure--x$!0)a_*oe8ldbwo32b7h98z6qq)&@+b_@0er+)za8nk@!1s#'
...
CSRF_TRUSTED_ORIGINS = ['http://127.0.0.1:8000/','https://twitter.sujeetshivman.repl.co']
...
DATABASES = {
    'default': {
        ...
        'PORT': 5432,
        'PASSWORD': '045dbcbdcb4505935b2a8656c63175ba28d1ec7f08525ff8f8421c9cd9abf608',
    }
}
